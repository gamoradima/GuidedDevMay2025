	...
	public class UsrRealtyEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("b125955c-1008-2c1b-9eb4-beb11f8e6b60"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("b346bd16-b453-47b0-b1f2-adc845be51a7"),
				CreatedInSchemaUId = new Guid("59ed12e4-5a24-448f-b787-59b39cbd4dd6"),
				ModifiedInSchemaUId = new Guid("59ed12e4-5a24-448f-b787-59b39cbd4dd6")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("59ed12e4-5a24-448f-b787-59b39cbd4dd6"));
		}
